...
export const AppInfoComp: FC<{ siteInfo: AppInfo }> = ({ siteInfo }) => {
  ...
  return (
    <div>
      <div className='flex items-center py-2 text-xl font-medium text-[#00347F] rounded-md'>👏 {t('app.common.welcome')} {siteInfo.title}</div>
